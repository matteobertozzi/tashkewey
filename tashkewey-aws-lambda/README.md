...
COPY tashkewey-aws-lambda/target/tashkewey-aws-lambda-shaded.jar ${LAMBDA_TASK_ROOT}/lib/tashkewey-aws-lambda-shaded.jar
COPY tashkewey-aws-lambda/target/lib/* ${LAMBDA_TASK_ROOT}/lib/
COPY demo-service/target/demo-service-0.1.0-SNAPSHOT.jar  ${LAMBDA_TASK_ROOT}/lib/
