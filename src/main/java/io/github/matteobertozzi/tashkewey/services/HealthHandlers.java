...
public class HealthHandlers {
  ...
  @NoTraceDump
  @AllowPublicAccess
  @UriMapping(uri = "/health")
  public Map<String, Object> health() {
    return Map.of(
      "uptime", JvmMetrics.INSTANCE.getUptime(),
      "mem.used", JvmMemoryMetrics.INSTANCE.usedMemory(),
      "mem.avail", JvmMemoryMetrics.INSTANCE.availableMemory()
    );
  }
}
